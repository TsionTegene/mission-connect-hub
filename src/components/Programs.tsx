  ...
  const programs = [
    {
      ...
      description: "Empowering communities through sustainable infrastructure projects, local leadership training, and economic opportunity initiatives.",
      image: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=800&q=80"
    },
    {
      title: "Education Support",
      description: "Providing access to quality education through school construction, teacher training, scholarship programs, and educational resources.",
      image: "https://images.unsplash.com/photo-1472396961693-142e6e269027?auto=format&fit=crop&w=800&q=80"
    },
    {
      title: "Health & Wellness",
      description: "Improving community health through medical missions, preventative care education, clean water initiatives, and nutrition programs.",
      ...
      <div className="section-container">
        <AnimatedSection>
          ...
          <p className="section-subtitle mx-auto text-center">
            Through our strategic programs, we address critical needs while building capacity for long-term change.
          </p>
        </AnimatedSection>
              ...
              <div className={cn(
                ...
                <div className="glass rounded-xl overflow-hidden h-full flex flex-col">
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    <p className="text-foreground/80 text-sm flex-1">{program.description}</p>
                    <div className="mt-4">
                      <a 
                        href="#" 
